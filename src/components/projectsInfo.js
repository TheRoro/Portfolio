const drawly = {
  ...
  palette: [
    ...
    { background: "#f59e0b", text: "#111827" },
    { background: "#22c55e", text: "#052e16" },
  ],
  imgUrl: "drawly.png",
...
const upspell = {
  ...
  palette: [
    ...
    { background: "#fcd34d", text: "#000000" },
    { background: "#2a2a29", text: "#FFFFFF" },
    { background: "#ffffff", text: "#353535" },
...
const repoColors = {
  ...
  palette: [
    ...
    { background: "#238636", text: "#FFFFFF" },
    { background: "#2f81f7", text: "#FFFFFF" },
    { background: "#a371f7", text: "#0d1117" },
    { background: "#f0f6fc", text: "#1f2328" },
  ],
...
const portfolio = {
  ...
  palette: [
    ...
    { background: "#d4ddf8", text: "#000000" },
    { background: "#8980f5", text: "#FFFFFF" },
    { background: "#ff7979", text: "#FFFFFF" },
  ],
...
const bodega = {
  ...
  palette: [
    { background: "#FAFAFA", text: "#353535" },
    { background: "#FF6699", text: "#FFFFFF" },
    { background: "#1A1A1A", text: "#FFFFFF" },
    { background: "#777777", text: "#FFFFFF" },
